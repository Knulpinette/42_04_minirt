...
#### Essential Links
* [The MiniLibX documentation](https://harm-smits.github.io/42docs/libs/minilibx)
...
* A [class on linear algebra](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) to learn all about vectors and maths
...
* [Ray Tracing in One Week End](https://www.scratchapixel.com/lessons/3d-basic-rendering/minimal-ray-tracer-rendering-simple-shapes) (and [the sequels](https://raytracing.github.io/) if you're someone somewhat suicidal)
...
* [MiniRT gmzorz](https://github.com/gmzorz/MiniRT)
